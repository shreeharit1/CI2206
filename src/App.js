...
function App() {
  return (
    <div className="App">
      ...
      <img src ="https://www.qentelli.com/sites/default/files/2021-05/Continuous%20Integration%201.jpg"></img>
      ...
      <h1>Getting error in build command ,it resolve ,then it  will work now</h1>
      <h1>Getting error in build command ,it resolve ,it should work now</h1>
